...
namespace PhotosErasmusApp.Data.Migrations
{
    ...
    [Migration("20250508105224_UserNameData")]
    partial class UserNameData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotosErasmusApp.Models.Categories", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhotosErasmusApp.Models.Likes", b =>
                {
                    b.HasOne("PhotosErasmusApp.Models.MyUsers", "Person")
                        .WithMany("ListOfLikes")
                        .HasForeignKey("PersonFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PhotosErasmusApp.Models.Photos", "Photo")
                        .WithMany("ListOfLikes")
            ...
            modelBuilder.Entity("PhotosErasmusApp.Models.Photos", b =>
                {
                    b.HasOne("PhotosErasmusApp.Models.Categories", "Category")
                        .WithMany("PhotosList")
                        .HasForeignKey("CategoryFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PhotosErasmusApp.Models.MyUsers", "Owner")
                        .WithMany("PhotosList")
